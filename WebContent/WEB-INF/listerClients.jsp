...
<html>
    ...
    <body>
        ...
        <c:choose>
            ...
            <c:when test="${ empty sessionScope.sessionClients }">
            ...
            <table>
                ...
                <c:forEach items="${ sessionScope.sessionClients }" var="mapClients" varStatus="boucle">
                ...
                <tr class="${boucle.index % 2 == 0 ? 'pair' : 'impair'}">
                    ...
                    <td><c:out value="${ mapClients.value.tel }"/></td>
