...
public final class CreationCommandeForm {
    ...
    private static final String SESSION_CLIENTS        = "sessionClients";
    ...
    public Commande creerCommande( HttpServletRequest request ) {
        ...
        if ( ANCIEN_CLIENT.equals( choixNouveauClient ) ) {
            ...
            try {
                validationAncienClient( nomAncienClient );
            } catch ( Exception e ) {
                setErreur( CHAMP_LISTE_CLIENTS, e.getMessage() );
            }
    ...
    private void validationAncienClient( String nomAncienClient ) throws Exception {
        if ( nomAncienClient == null ) {
            throw new Exception( "Merci d'entrer un client." );
        }
    }
